...
public class MoreActivity extends AppCompatActivity {
    ...
    private TextView txtAboutUs, txtFeedback, txtDisclaimer, txtPrivacyPolicy, txtCicContactInformation, mTxtCommonMistakes;
...
//                emailIntent.putExtra(Intent.EXTRA_SUBJECT, subject);
        ...
        txtPrivacyPolicy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MoreActivity.this, CommonMistakeActivity.class);
                startActivity(intent);
            }
        });
        ...
        mTxtCommonMistakes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Log.d("More","CommonMstake");
                CommonMistakeActivity.Companion.launch(MoreActivity.this);
            }
        });
    }
