...
public class Fst extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String fst_desc = App.getContext().getString(R.string.fst_desc);
        Spanned styled_fst_long_desc = Html.fromHtml(fst_desc, Html.FROM_HTML_MODE_LEGACY);
        setTextViewHTML(txtFstDesc, styled_fst_long_desc);
    }
...
//                Toast.makeText(getApplicationContext(), "Link Clicked "+ span.getURL(), Toast.LENGTH_SHORT).show();
    ...
    private void initViews() {
        ...
        txtFstDesc = findViewById(R.id.txtFstDesc);
    }
}