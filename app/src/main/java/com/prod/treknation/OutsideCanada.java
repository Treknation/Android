...
public class OutsideCanada extends AppCompatActivity {
    private ImageView btnBackArrow;
    private TextView txtOutsideCanada;

    @RequiresApi(api = Build.VERSION_CODES.N)
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_outside_canada);
        initViews();

        txtOutsideCanada.setMovementMethod(LinkMovementMethod.getInstance());
        btnBackArrow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                OutsideCanada.this.finish();
            }
        });
        ...
        setTextViewHTML(txtOutsideCanada, styled_outside_canada);
    }
...
//                Toast.makeText(getApplicationContext(), "Link Clicked "+ span.getURL(), Toast.LENGTH_SHORT).show();
    ...
    private void initViews() {
        ...
        txtOutsideCanada = findViewById(R.id.txtOutsideCanada);
    }
}